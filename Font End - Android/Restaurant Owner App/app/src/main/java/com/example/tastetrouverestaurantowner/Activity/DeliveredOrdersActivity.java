...
public class DeliveredOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<PendingOrderModal>> call = APIClient.getInstance().getApi().getDeliveredOrders(ownerId,"delivered");
        ...
        call.enqueue(new Callback<List<PendingOrderModal>>() {
            ...
            public void onResponse(Call<List<PendingOrderModal>> call, Response<List<PendingOrderModal>> response) {
                ...
                AcceptedOrderAdapter customAdapter= new AcceptedOrderAdapter(pendingOrderModalArrayList,DeliveredOrdersActivity.this);

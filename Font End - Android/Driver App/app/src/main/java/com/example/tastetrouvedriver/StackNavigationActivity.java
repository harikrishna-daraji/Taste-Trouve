...
public class StackNavigationActivity extends AppCompatActivity implements  OnNavigationReadyCallback, NavigationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stack_navigation);
...
// Get the directions route
                ...
                navigationView.startNavigation(NavigationViewOptions.builder(StackNavigationActivity.this).directionsRoute(currentRoute).shouldSimulateRoute(true).navigationListener(StackNavigationActivity.this).build());
// Make a toast which displays the route's distance
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                ...
                Toast.makeText(StackNavigationActivity.this, "Error: " + throwable.getMessage(),
